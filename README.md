...
├── LICENSE.txt     # Required: License (GPLv3 recommended)
...
Individual skills contain their own LICENSE.txt files. The repository and all included skills are licensed under the GNU General Public License v3.0 (GPLv3).
